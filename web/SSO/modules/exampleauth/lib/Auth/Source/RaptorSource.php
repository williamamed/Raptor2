...
class sspmod_exampleauth_Auth_Source_RaptorSource extends sspmod_core_Auth_UserPassBase {
	...
	protected function login($username, $password) {
        ...
        $file = @fopen("http://localhost/Raptor2/web/index.php/raptor/syntarsus/login?username=$username&password=$password", "r");
        if (!$file) {
